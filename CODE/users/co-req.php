...
<html>
    <head>
        ...
        <title>Co-ordinator | New Requirements</title>
        ...
        <table class="table table-bordered table-striped table-dark" style="width: 90%;text-align: center "
            ...
            <thead class="">
                <tr>
                    ...
                    <th data-field="actn">No. of Students Required</th>
                    <th data-field="Resum">view<br>Eligible Students</th>
            ...
            <tbody class="thead-dark">
                ...
                $sql = "SELECT hod_list FROM req where hodsts=0 and fullfill=0";
                $cnt = 0;
                $result = $db->query($sql);
                $row1 = $result->fetch_assoc();
                $sql = "SELECT * FROM req where fullfill=0 and hod_list LIKE '%".$br."%'";
                $cnt = 0;
                $result = $db->query($sql);
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td scope="col"><a class="btn btn-primary btn-sm" href="stud_find.php?id=<?php echo $id ?>" target="_BLANK">View</a></td>
                      </tr>
                    <?php
                }
                ?>
