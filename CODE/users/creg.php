  ...
  if (a == "" ||b == ""||c == "" ||d == ""||e == "") {
    ...
    <body>
        ...
        <div class="modal-body">
            <br>
            <form method="post" action="creg.php" id="myForm" onsubmit="return validateForm()" class="was-validated" id='frm1' novalidate>
                <!--label for="personaldetails" style="color: #667eea;font-size:16pt;">Personal Details</label-->
                <div class="form-row">
                    <div class="col">
                        <input style="color:white" type="text" class="form-control bg-dark" placeholder="Company name" required="" name="fnm">
                    </div>
                </div>
                <br>
...
if(isset($_POST['Register']))
{
    ...
    $sql="INSERT INTO login_info VALUES ('','$unm','$pass','$fnm','$eml','$mob','2','')";
