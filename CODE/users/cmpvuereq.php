...
<html>
    <head>
        ...
        <title>Company | Old Requirements</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="form-inline my-2 my-lg-0">
                    <!input class="form-control b mr-sm-2" type="search" placeholder="Search" aria-label="Search">
        ...
        <table class="table table-bordered table-striped table-dark" style="width: 90%;text-align: center "
            ...
            <thead class="">
                <tr>
                    ...
                    <th data-field="asts">View Eligible <br>Students List</th>
            ...
            <tbody class="thead-dark">
                ...
                $sql = "SELECT * FROM req where costs=1 and cid=$cid";
                $cnt = 0;
                $result = $db->query($sql);
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td scope="col"><?php if($row['fullfill']==0){echo "<a class='btn btn-danger btn-sm'>Pending</a>";}else {echo "<a class='btn btn-success btn-sm' href='stud_sel.php?id=$id' title='Click to View Students list'>View List</a>";}?></td>
                    </tr>
                    <?php
                }
                ?>
                    ...
                    <div class="modal-body">
                        <form method="post" action="tpofhod.php" target="_BLANK">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-dark reqid" name="reqid" id="recipient-name" readonly="">
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
