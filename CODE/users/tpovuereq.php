...
<html>
    <head>
        ...
        <title>TPO | New Requirements</title>
    ...
    <body style=" background-image: url(../img/black.jpg);	height: 100vh;	background-size: cover;	background-position: center;">
        ...
        <table class="table table-bordered table-striped table-dark" style="width: 90%;text-align: center "
            ...
            <thead class="">
                <tr>
                    ...
                    <th data-field="Resum">Forward To Department</th>
            ...
            <tbody class="thead-dark">
                ...
                $sql = "SELECT * FROM req where costs=0 and fullfill=0";
                $cnt = 0;
                $result = $db->query($sql);
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td scope="col"><a class="btn btn-primary btn-sm" data-whatever="<?php echo $id ?>" data-toggle="modal" data-target="#exampleModal">Forward</a></td>
                      </tr>
                    <?php
                }
                ?>
