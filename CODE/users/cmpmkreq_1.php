...
<html>
    ...
    <body>
        ...
        <div class="modal-body">
            <br>
            <form method="post" action="make.php" target="_BLANK" id="myForm" class="was-validated" id='frm1' novalidate enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <select required="" name="cond" class="form-control bg-dark" style="color: white">
                    ...
                    <div class="form-group col-md-6">
                        <input style="color:white" type="number" class="form-control bg-dark " placeholder="Aggregate Percentage" required="" name="perc">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <select required="" style="color: white" name="passout" class="form-control bg-dark">
                    ...
                    <div class="form-group col-md-6">
                        <input type="number" class="form-control bg-dark" style="color:white" placeholder="Number of Required Student" required="" name="no">
                    </div>
                </div>
