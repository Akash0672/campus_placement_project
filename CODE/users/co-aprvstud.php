...
<html>
    <head>
        ...
        <title>Co-ordinator | Approve Student</title>
    ...
    <body style="height: 100vh">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="co-home.php">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <hr style="border: 1px solid red;">
            <center>
                <table class="table table-bordered table-striped table-dark" style="width: 90%;text-align: center "
                    ...
                    <thead class="">
                        <tr>
                            ...
                            <th data-field="5th">Download 5th Sem Result</th>
				 <th data-field="6th">Download 6th Sem Result</th>
				  <th data-field="Resum">Download Undertaking</th>
				 <th data-field="ut">Download Resume</th>
                        
                            <th data-field="actn">Action</th>
                        </tr>
                    </thead>
                    <tbody class="thead-dark">
                        ...
                        $sql = "SELECT * from stud_info where branch='$br' and sts=0 ORDER BY passout DESC,fnm ASC";
                        $cnt=0;
                        $result = $db->query($sql);
				...
				<td scope="col"><a href="./get_file2.php?id=<?php echo $id ?>">Download</a></td>
				<td scope="col"><a href="./get_file3.php?id=<?php echo $id ?>">Download</a></td>
                                <td scope="col"><a href="./get_file.php?id=<?php echo $id ?>">Download</a></td>
				<td scope="col"><a href="./get_file1.php?id=<?php echo $id ?>">Download</a></td>
                                <td scope="col"><a href="aprv_stud.php?id=<?php echo $id ?>" target="_BLANK" onclick="function a(){alert('Approved..!');}a();">Approve</a></td>
                            </tr>
                            <?php
                        }
                        ?>
