        ...
        <table class="table table-bordered table-striped table-dark" style="width: 90%;text-align: center "
            ...
            <thead class="">
                <tr>
                    ...
                    <th data-field="asts">Departmental<br>Approval Status</th>
            ...
            <tbody class="thead-dark">
                ...
                $sql = "SELECT * FROM req where costs=1 and branch like '%$br%'" ;
                //echo $sql;
                $cnt = 0;
                $result = $db->query($sql);
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <?php $str=$row['hod_list'];$br="'".$br."'";$a=strstr("$str","$br",0);?>
                        <td scope="col"><?php if($a){echo "<a class='btn btn-danger btn-sm'>Pending</a>";}else {echo "<a class='btn btn-success btn-sm' href='vuestud.php?id=$id' title='Click to View Students list'>Approved</a>";}?></td>
                    </tr>
                    <?php
                }
                ?>
